  ...
  private async setupEditor() {
    ...
    this.editor = new Editor({
      ...
      editorProps: {
        attributes: {
          class: `${
            this.mode === 'edit' ? 'p-2.5 focus-visible:outline-none' : ''
          } rounded-lg disabled:bg-secondary-100 max-w-none prose prose-sm prose-slate prose-p:text-slate-900 prose-p:m-0 prose-p:mb-[0.625rem] prose-li:m-0 ${this.class}`,
        },
      },
